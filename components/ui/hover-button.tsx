...
const HoverButton = React.forwardRef<HTMLButtonElement, HoverButtonProps>(({ className, children, ...props }, ref) => {
  ...
  return (
    <button
      ref={buttonRef}
      className={cn(
        "relative isolate px-8 py-3 rounded-full", // Changed to rounded-full for consistency with previous button
        "text-white font-semibold text-base leading-6", // Changed text to white and font-semibold
        "bg-gray-900", // Changed background to dark gray
        "cursor-pointer overflow-hidden",
        "before:content-[''] before:absolute before:inset-0",
        "before:rounded-[inherit] before:pointer-events-none",
        "before:z-[1]",
        "before:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2),inset_0_0_16px_0_rgba(0,0,0,0.1),inset_0_-3px_12px_0_rgba(0,0,0,0.15),0_1px_3px_0_rgba(0,0,0,0.50),0_4px_12px_0_rgba(0,0,0,0.45)]", // Adjusted shadows for dark background
      ...
      {...props}
      style={{
        "--circle-start": "#ef4444", // Red-500
        "--circle-end": "#dc2626", // Red-700
      }}
    >
